...
// MarkWhatsAppMessageAsReadToUser marks a message as read using the legacy global API.
...
// MarkWhatsAppMessageAsReadToUserByWorkspace marks a message as read using workspace-specific API.
func MarkWhatsAppMessageAsReadToUserByWorkspace(
	entity message_entity.Message,
